...
public final class Entrada extends Obstaculos  { //é a classe combate sem overrite enquanto estou trabalhando nela
    ...
    public void introdução() {
        ...
        do {
            ...
            int action = scanner.nextInt(); //ATENÇÃO Criar um try catch, deve ser inteiro e deve ser dentro do indice de opções
            switch (action) {
                case 1:
    ...
    public void desafio() {
        ...
        do {
            ...
            System.out.println("2) Se aproximar do portão sem o Pr0t0"); //Ver como exatamente farei sobre o combate, algo como dano toda rodada até resolver o problema?
        ...
        if (id == 2) {
            ...
            if (id == 1) { //Fazer uma excessão pra caso fuga tenha sido bem sucedida, um if pegando esse if else
                if (turno > 2) {
                    ...
                    System.out.println("O fim do combate ocorre mas o portão já se encontra fechado a sau frente, ele é grande demais para ser destrudio, você precisa encontrar outro caminho");
                }
            } else {
