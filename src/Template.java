...
//Quando termina-las tem que colocar na interface de personagem também
    ...
    public void instruçõesCombate() {
        ...
        System.out.println("Ele pode usar suas técnicas de relojoeiro, essas ações ocorrem apenas no final do turno e custam engrenagens e talvez outros itens limitados, mesmo assim, elas são extremamente poderosas:");
